...
export JAVA_OPTS="-server -Xms512m -Xmx512m -XX:MaxPermSize=128m -Dorg.jboss.logging.Log4jService.catchSystemOut=false -Xdebug -agentlib:jdwp=transport=dt_socket,address=5000,suspend=n,server=y"
